      ...
      if (isUser) {
        ...
        parts.push(
          <AgentMentionTooltip key={`m-${match.index}`} agent={agent}>
            <span
              className="inline align-middle font-mono text-[10px] px-1 py-0.5 rounded cursor-pointer transition-colors bg-blue-500/20 dark:bg-blue-400/30 text-blue-600 dark:text-blue-200 hover:bg-blue-500/30 dark:hover:bg-blue-400/40"
