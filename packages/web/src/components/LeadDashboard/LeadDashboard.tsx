...
export function LeadDashboard({ readOnly = false }: Props) {
  ...
  useQuery({
    queryKey: ['lead', selectedLeadId, 'progress'],
    queryFn: async ({ signal }) => {
  ...
  useQuery({
    queryKey: ['lead', selectedLeadId, 'decisions'],
    queryFn: async ({ signal }) => {
      const data = await apiFetch(`/lead/${selectedLeadId}/decisions`, { signal });
  ...
  useQuery({
    queryKey: ['lead', selectedLeadId, 'groups'],
    queryFn: async ({ signal }) => {
  ...
  useQuery({
    queryKey: ['lead', selectedLeadId, 'dag'],
    queryFn: async ({ signal }) => {
