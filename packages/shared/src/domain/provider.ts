...
export const PROVIDER_REGISTRY: Record<ProviderId, ProviderDefinition> = {
  copilot: {
    ...
    tierModels: { fast: 'claude-haiku-4.5', standard: 'claude-sonnet-5', premium: 'claude-opus-4.8' },
  ...
  opencode: {
    ...
    tierModels: { fast: 'anthropic/claude-haiku-4-5', standard: 'anthropic/claude-sonnet-5', premium: 'anthropic/claude-opus-4-6' },
