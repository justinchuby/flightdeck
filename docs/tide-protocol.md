...
*This document is part of the [AI Crew architecture documentation](./README.md). For related protocols, see [Agent Coordination](./coordination.md) and [Agent Communication](./agent-communication.md).*
